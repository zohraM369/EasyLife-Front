  ...
  return (
    <div className="mt-4 bg-gradient-to-b from-blue-400 to-blue-600 p-6 rounded-2xl shadow-lg w-5/6 mx-auto">
     <div className="shadow shadow-lg flex items-center justify-center text-center current-weather">
       ...
       <h2 className='text-2xl font-semibold text-white capitalize '>{user?.city}</h2> 
        <img className=' h-45' src={weatherData?.currentIcon} alt="Current Weather Icon" />
        <h2 className='text-2xl font-semibold text-white'>  {weatherData?.currentTemp}</h2>
      </div>
