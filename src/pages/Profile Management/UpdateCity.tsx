 ...
 const handleBack = () => {
  ...
  return (
    <div className="p-8  mx-auto bg-white shadow-md rounded-md">
      <h2 className="text-xl font-semibold text-blue-500 mb-4">Modifier Votre Ville</h2>
      <div className="mb-4">
        <label className="block text-sm font-medium text-gray-700">Nouvelle Ville</label>
        <input
          type="email"
          value={newCity}
